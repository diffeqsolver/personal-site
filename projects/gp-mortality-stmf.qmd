...
This project is a full solution to **Research Project 6: Advanced GP Modeling of Short-Term Mortality Data** from Springer's *An Invitation to Undergraduate Research in Risk Management* — a companion piece to the [GP metamodeling project](gaussian-process-valuation.qmd), pointing the same GPyTorch toolkit at open mortality data. All code, data, and figures live in the [GitHub repo](https://github.com/diffeqsolver/mortality-gp).
